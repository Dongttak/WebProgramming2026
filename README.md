...
- 작성자가 구인 완료/구인 재개 상태 변경 가능
- 카테고리별 게시판: 팀플, 밥, 룸메, 외국인 교류
- 카테고리별 필수 정보: 팀플 활동 내역, 밥 메뉴/음주여부, 외국인 교류 희망 언어/제공 언어/취미/활동 가능 지역
- 태그/검색 기능
...
6. 내 정보 저장
7. 매칭 글 작성
8. 카테고리별 필수 정보가 표시되는지 확인
9. 카테고리별 게시판 필터 확인
10. 태그 검색 확인
11. 상세 조회에서 연락처가 승인 전 숨겨지는지 확인
12. 다른 계정으로 신청 댓글 작성
13. 작성자 계정으로 신청자 프로필/연락처 확인 및 승인
14. 승인된 신청자 계정에서 글쓴이 연락처 확인
15. 구인 완료 상태 변경과 완료 글 신청 차단 확인
16. 글 수정 불가 안내 확인
17. 글 삭제 확인
18. AI 추천 버튼 확인
19. Console/CORS 오류 확인
